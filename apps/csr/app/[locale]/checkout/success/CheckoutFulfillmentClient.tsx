...
export default function CheckoutFulfillmentClient({ sessionId }: { sessionId?: string }) {
  ...
  if (!canFulfill) {
    return (
      <p className="r-text-sm text-amber-700 bg-amber-50 border border-amber-200 rounded-md r-p-sm">
  ...
  if (state === 'processing' || state === 'idle') {
    return (
      <p className="r-text-sm text-blue-700 bg-blue-50 border border-blue-200 rounded-md r-p-sm">
  ...
  if (state === 'done') {
    return (
      <p className="r-text-sm text-green-700 bg-green-50 border border-green-200 rounded-md r-p-sm">
  ...
  return (
    <p className="r-text-sm text-red-700 bg-red-50 border border-red-200 rounded-md r-p-sm">
