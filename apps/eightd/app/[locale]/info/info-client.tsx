...
export default function EightDInfoPage({ content }: { content: InfoPage }) {
    ...
    <main className="min-h-dvh bg-neutral-50 text-neutral-900">
      ...
      <section className="mx-auto max-w-[860px] px-6 pb-12 pt-16 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <Button render={<a href="/demo/8D-Report-8D-2024-031.pdf" download="8D-Report-8D-2024-031.pdf" className="flex items-center justify-center gap-2" />} variant="outline" size="lg" className="rounded-full border-blue-200 bg-white text-blue-600 hover:bg-blue-50 hover:border-blue-600 text-sm font-semibold h-12 w-full sm:w-52">
      ...
      <section className="mx-auto mb-20 max-w-[960px] px-6">
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
          {disciplines.map((d) => (
            ...
            >
              <div
                className="mb-2 text-2xl text-blue-600 transition-transform group-hover:scale-110 origin-left"
                style={{ fontFamily: "'DM Serif Display', serif" }}
              >
                {d.num}
              </div>
              <h4 className="mb-2 text-[0.95rem] font-bold text-neutral-900">
                {(content as any)[`${d.key}Title`] || t(`${d.key}Title`)}
              </h4>
              <p className="text-[0.8rem] leading-relaxed text-neutral-500">
                {(content as any)[`${d.key}Desc`] || t(`${d.key}Desc`)}
              </p>
            </div>
          ))}
        </div>
          ...
          <div className="mx-auto flex flex-col items-center gap-16 lg:flex-row lg:items-center">
            <div className="flex-1 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 lg:justify-start">
                <Button render={<a href="/demo/8d-report-sample.pdf" download className="flex items-center justify-center gap-2" />} size="lg" className="rounded-full bg-white text-blue-600 hover:bg-blue-50 shadow-lg shadow-black/15 text-sm font-semibold h-12 w-full sm:w-56">
                  <Download className="h-5 w-5" />
            ...
            <div className="relative w-full max-w-[280px] flex-shrink-0 animate-float lg:max-w-[320px]">
              <div className="rounded-3xl bg-white p-8 shadow-2xl shadow-black/40">
                ...
                {[
                  { label: 'D1', title: t('docD1'), width: 'w-4/5' },
                  { label: 'D2', title: t('docD2'), width: 'w-full' },
                  { label: 'D4', title: t('docD4'), width: 'w-3/4' },
                  { label: 'D5–D8', title: t('docD5D8'), width: 'w-5/6' },
                ].map((item, idx) => (
      ...
      <section className="mx-auto max-w-[720px] px-6 pb-24 pt-10 text-center">
        <div className="rounded-[2.5rem] bg-white px-8 py-16 border border-neutral-200 shadow-sm">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Button render={<a href={`/${locale}/generator`} className="flex items-center justify-center gap-2" />} variant="outline" size="lg" className="rounded-full border-blue-200 bg-white text-blue-600 hover:bg-blue-50 hover:border-blue-600 text-sm font-semibold h-12 w-full sm:w-52">
              <ArrowRight className="h-5 w-5" />
